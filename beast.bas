...
30 DATA 00,00,00,00,00,00,03,02,05,02,03,00,00,00,00,00
40 DATA 00,00,00,00,00,00,00,C0,60,C0,00,00,00,00,00,00
...
100  XX! = XX! - DX!  :if XX<0 then XX=255 : goto 100 : else K$=inkey$:    :     vpoke30217,INT(XX!):                   IFK$=""then100:elsek=asc(k$): 
...
2000 beep : XX! = 255 :  DX! =RND(1) : vpoke30217,INT(XX!):  return 
