...
80 X=100:Y=150:rem PUT SPRITE 0,(X,Y),4,0:PUT SPRITE 1,(X,Y),5,1:PUT SPRITE 2,(X,Y),11,2:PUT SPRITE 3,(X,Y),13,3
90 pset(0,40): color 6,6,1: cls :for i=0to62 :  color 9  :print#1,chr$(&hc0+RND(1)*6); : next i
92 pset(0,80): for i=0to124:  color 8  :print#1,chr$(&hdb+RND(1)*4); : next i
93 LINE(00,120)-(300,220),8,BF:  for P=0to10  : FOR H=0 TO 255 :SET SCROLL H,0,1,1	:NEXTH: : nextP
