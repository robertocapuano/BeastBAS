30 DATA 00,00,00,00,00,00,00,00,40,00,03,03,00,00,08,00
40 DATA 00,00,00,00,C0,00,00,08,00,00,80,80,00,00,70,00
60 DATA 00,00,00,03,07,07,07,01,3F,00,00,00,07,04,04,00
61 DATA 00,00,00,E0,00,C0,80,F0,E0,80,00,00,E0,A0,00,00


70 color 6,6,1:SCREEN 5,3,0:: :KEYOFF:DEFINTA-Z: :open"grp:"as#1:S=&h7800 : :forI=0 to 63: READ R$: VPOKE S+I,VAL("&H"+R$):NEXTI:
80 X=100:Y=150:PUT SPRITE 0,(X,Y),10,0:PUT SPRITE 1,(X,Y),6,1:
90 pset(0,40): color 6,6,1: cls :for i=0to61 :  color 9  :print#1,chr$(&hc0+RND(1)*6); : next i
