3 DATA 00,00,0F,01,01,01,03,0F,0F,0F,0E,00,00,19,31,00
...
75 color 6,6,1:SCREEN 5,3,0:: :KEYOFF:DEFINTA-Z: :open"grp:"as#1:S=&h7800 : :forI=0 to 63: READ R$: VPOKE S+I,VAL("&H"+R$):NEXTI:
80 X=100:Y=150:PUT SPRITE 0,(X,Y),6,0:PUT SPRITE 1,(X,Y),9,1:
